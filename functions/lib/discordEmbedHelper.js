...
exports.ITEM_CATEGORY_MAP = exports.DISCORD_THEME_COLORS = void 0;
exports.sanitizePii = sanitizePii;
exports.parseDateSafe = parseDateSafe;
exports.formatToBrtDate = formatToBrtDate;
exports.formatToBrtDateTime = formatToBrtDateTime;
exports.getIsoDatabaseTimestamp = getIsoDatabaseTimestamp;
exports.buildNovosAchadosEmbed = buildNovosAchadosEmbed;
exports.buildNovasPerdasEmbed = buildNovasPerdasEmbed;
/**
 * Palette mapping for categories, status, and urgency
 */
exports.DISCORD_THEME_COLORS = {
 ...
 */
function formatToBrtDate(dateInput) {
 ...
 */
function formatToBrtDateTime(dateInput) {
    const parsed = parseDateSafe(dateInput);
    if (!parsed)
 ...
 */
function buildNovosAchadosEmbed(item) {
    ...
    const categoryInfo = exports.ITEM_CATEGORY_MAP[categoryKey] || {
    ...
    const embed = {
        ...
        color: exports.DISCORD_THEME_COLORS.NEW_FOUND_ITEM,
        fields,
        footer: {
 ...
 */
function buildNovasPerdasEmbed(item) {
    ...
    const embed = {
        ...
        description: sanitizedDesc,
        color: exports.DISCORD_THEME_COLORS.LOST_ITEM, // Amber 0xf59e0b
        fields,
        footer: {
            text: "IFPR Campus Ivaiporã • Central de Achados e Perdidos • Evento Registrado",
            icon_url: "https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/shield-check.png",
...
//# sourceMappingURL=discordEmbedHelper.js.map